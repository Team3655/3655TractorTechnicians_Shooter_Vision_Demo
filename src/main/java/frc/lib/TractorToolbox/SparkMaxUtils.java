...
public class SparkMaxUtils {
	 ...
	 */
	public static CANSparkMax createSparkMax(int motorID, int smartCurrentLimit, IdleMode idleMode) {
	 ...
	 *                  2pi for radians, Circumfrance for wheels, etc.)
	 ...
	 * SmartDashboard (this is used to streamline moter telemetry, and ensure all
	 * relevent data is collected)
	 * 
	...
	public static void sendMoterTelemetry(String motorName, CANSparkMax motor) {
		...
		SmartDashboard.putNumber(motorName + " Current", motor.getOutputCurrent());
		SmartDashboard.putNumber(motorName + " Output", motor.getAppliedOutput());
